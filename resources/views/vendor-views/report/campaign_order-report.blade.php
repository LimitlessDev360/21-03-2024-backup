                ...
                <form  method="get">
                    <div class="row g-3">
                        <div class="col-sm-6 col-md-3">
                            <select name="campaign_id" class="form-control js-select2-custom set-filter"
                                data-url="{{ url()->full() }}" data-filter="campaign_id" id="campaign_id">
            ...
            <div class="row g-4">
                <div class="col-lg-3">
                    <a class="__card-1 h-100" href="#">
                        <img src="{{dynamicAsset('/public/assets/admin/img/report/new/total.png')}}" class="icon" alt="report/new">
                ...
                <div class="col-lg-9">
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6 col-md-4">
                            ...
                            <img src="{{dynamicAsset('/public/assets/admin/img/report/new/on-the-way.png')}}" alt="report/new" class="card-icon">
                            </a>
                        </div>
                        <div class="col-sm-6 col-md-4">
                            ...
                            <img src="{{dynamicAsset('/public/assets/admin/img/report/new/delivered.png')}}" alt="report/new" class="card-icon">
                            </a>
                        </div>
                        <div class="col-sm-6 col-md-4">
                            ...
                            <img src="{{dynamicAsset('/public/assets/admin/img/report/new/failed.png')}}" alt="report/new" class="card-icon">
                            </a>
                        </div>
                        <div class="col-sm-6 col-md-4">
                            ...
                            <img src="{{dynamicAsset('/public/assets/admin/img/report/new/refunded.png')}}" alt="report/new" class="card-icon">
                            </a>
                        </div>
                        <div class="col-sm-6 col-md-4">
                            ...
                            <img src="{{dynamicAsset('/public/assets/admin/img/report/new/canceled.png')}}" alt="report/new" class="card-icon">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="hs-unfold ml-3">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                                href="{{ route('vendor.report.campaign_report_export', ['type' => 'excel', request()->getQueryString()]) }}">
                            ...
                            <a id="export-csv" class="dropdown-item"
                                href="{{ route('vendor.report.campaign_report_export', ['type' => 'csv', request()->getQueryString()]) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
