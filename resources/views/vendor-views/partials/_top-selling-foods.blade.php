...
<div class="card-header">
    <h5 class="card-header-title align-items-center d-flex">
        ...
        <span>{{translate('messages.top_selling_Product')}}</span>
    </h5>
</div>
<!-- End Header -->
            ...
            <div class="col-md-4 col-sm-6">
                <div class="grid-card top-selling-food-card pt-0 redirect-url" data-url="{{route('vendor.food.view',[$item['id']])}}">
                    <div class="position-relative">
                        ...
                        <img class="initial-43 onerror-image" src="{{\App\CentralLogics\Helpers::onerror_image_helper($item['image'], dynamicStorage('storage/app/public/product').'/'.$item['image'], dynamicAsset('public/assets/admin/img/100x100/food.png'), 'product/') }}"
