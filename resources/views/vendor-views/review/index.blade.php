                            ...
                            <td>
                                ...
                                <div class="position-relative media align-items-center">
                                    ...
                                    <img class="avatar avatar-lg mr-3  onerror-image"  data-onerror-image="{{dynamicAsset('public/assets/admin/img/100x100/food-default-image.png')}}"
                                         src="{{\App\CentralLogics\Helpers::onerror_image_helper($review->food['image'], dynamicStorage('storage/app/public/product/').'/'.$review->food['image'], dynamicAsset('public/assets/admin/img/100x100/food-default-image.png'), 'product/') }}" alt="{{$review->food->name}} image">
