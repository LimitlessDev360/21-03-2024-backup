            ...
            <div class="row g-2">
                            ...
                            <div class="form-group mb-0 h-100 d-flex flex-column align-items-center justify-content-center">
                                <label>
                                    <div id="image-viewer-section" class="my-auto text-center">
                                            ...
                                            src="{{\App\CentralLogics\Helpers::onerror_image_helper($product?->image, dynamicStorage('storage/app/public/product/'.$product?->image), dynamicAsset('/public/assets/admin/img/100x100/food-default-image.png'), 'product/') }}"
                                            alt="image">
                ...
                <div class="col-lg-12">
                    <div class="card shadow--card-2 border-0">
                        ...
                        <div class="card-body">
                            <input type="text" class="form-control" name="tags"  value="@foreach($product->tags as $c) {{$c->tag.','}} @endforeach" placeholder="{{ translate('Enter_tags') }}" data-role="tagsinput">
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
