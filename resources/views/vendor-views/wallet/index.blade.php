                            ...
                            @foreach($withdraw_req as $k=>$wr)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($wr->approved==0)
                                            <a class="btn btn-outline-danger btn--danger action-btn form-alert" data-id="withdraw-{{$wr['id']}}"  data-message="{{ translate('Want_to_delete_this_?') }}" href="javascript:"  title="{{translate('messages.delete')}}"><i class="tio-delete-outlined"></i>
                                        </a>
