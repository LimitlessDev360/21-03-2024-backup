        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--title" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                            title="{{ translate('messages.restaurant_section') }}">{{ translate('messages.vendor_management') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    ...
                    <li
                        ...
                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                            ...
                            <i class="tio-poi-outlined nav-icon"></i>
                            <span
                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.vendors') }}</span>
                        </a>
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: {{ (Request::is('admin/restaurant*') && !Request::is('admin/restaurant/withdraw_list') ||
                            ...
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.restaurant.add') }}" title="Add">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            ...
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.restaurant.list') }}" title="List">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span
                            ...
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    ...
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.joining_requests') }}
                                    </span>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle"
                            title="{{ translate('messages.food_section') }}">{{ translate('messages.product_management') }}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        <li class="nav-item {{ Request::is('admin/food/add-new') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.food.add-new') }}"
                                ...
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.add') }}</span>
                            </a>
                        </li>
                        <li
                            class="nav-item {{ Request::is('admin/food/list')  ||  Request::is('admin/food/view/*') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.food.list') }}" title="List">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.list') }}</span>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <small class="nav-subtitle"
                        title="{{ translate('messages.customer_section') }}">{{ translate('messages.service_charge_management') }}</small>
                    <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                </li>


                <li class="navbar-vertical-aside-has-menu">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.add-service') }}"
                        title="Add Service">
                ...
                <li class="navbar-vertical-aside-has-menu">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.service-list') }}"
                        title="Service list">
                        <i class="tio-calendar nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            List
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/vehicle/*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.vehicle.list') }}"
                        title="{{ translate('messages.vehicles_category_setup') }}">
                        <i class="tio-car nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            {{ translate('messages.vehicles_setup') }}
                        </span>
                    </a>
                </li>
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/shift*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.shift.list') }}"
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                ...
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{ translate('messages.joining_requests') }}
                                </span>
                            </a>
                        </li>
                        <li
                ...
                <li class="nav-item">
                    <small class="nav-subtitle"
                        title="{{ translate('messages.customer_section') }}">{{ translate('messages.slot_management') }}</small>
                    <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                </li>


                <li class="navbar-vertical-aside-has-menu">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.add-slots') }}"
                        title="Add slots">
                        <i class="tio-calendar nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            Add
                ...
                <li class="navbar-vertical-aside-has-menu">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.slot-lists') }}"
                        title="Slot list">
                        <i class="tio-calendar nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            List
                ...
                <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.customer.visitor_logs') }}"
                    title="{{ translate('Customer_Logs') }}">
                    <i class="tio-poi-user nav-icon"></i>
                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                        {{ translate('messages.customer_Logs') }}
                    </span>
                </a>
                </li> --}}
                ...
                <li
                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/report/disbursement-report') ? 'active' : '' }}">
                    <a class="nav-link " href="{{ route('admin.report.disbursement_report') }}"
                ...
                <li
                    ...
                    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                        ...
                        <span
                            class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.vendor_report') }}</span>
                    </a>
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        <li
                            ...
                            <a class="nav-link " href="{{ route('admin.report.restaurant-report') }}"
                                title="{{ translate('messages.restaurant_report') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.report') }}</span>
                            </a>
                        </li>
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/business-setup*')
                ...
                <!-- Subscription-->
                @if (\App\CentralLogics\Helpers::subscription_check() == true &&
                \App\CentralLogics\Helpers::module_permission_check('restaurant') )
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/subscription*') ? 'active' : '' }}">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        <li
                            class="nav-item {{ Request::is('admin/subscription/package/*') || Request::is('admin/subscription/search')  ||  Request::is('admin/subscription/transcation/list/*')? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.subscription.package_list') }}"
                                title="{{ translate('messages.Package_list') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.subscription_Packages') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('admin/subscription/list') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('admin.subscription.subscription_list') }}"
                                title="{{ translate('messages.subscription_list') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                ...
                <li
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        <li
                            class="nav-item {{ Request::is('admin/business-settings/payment-method') || Request::is('admin/business-settings/sms-module')|| Request::is('admin/business-settings/mail-config') || Request::is('admin/social-login/view') ||Request::is('admin/business-settings/config*') || Request::is('admin/business-settings/recaptcha*')  ? 'active' : '' }}">
                ...
                <li
                    ...
                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                        href="{{ route('admin.restaurant.withdraw_list') }}" title="Vendor withdraws">
                ...
                @if (\App\CentralLogics\Helpers::module_permission_check('account'))
                <li class="nav-item">
                    <small class="nav-subtitle" title="DeliveryMan Payment Settings">Deliveryman Payment
                        Settings</small>
                    <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                </li>
                ...
                <li class="navbar-vertical-aside-has-menu active">
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: none">
                        ...
                        <li class="navbar-vertical-aside-has-menu">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.deliveryman-requests.paid-amount-list') }}" title="Partial">
                                <i class="tio-wallet-outlined nav-icon"></i>
                ...
                <li class="navbar-vertical-aside-has-menu">
                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                        href="{{ route('admin.deliveryman-requests.deliveryman-bank-list') }}" title="Bank Details">
                        <i class="tio-send nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Bank Details</span>
                    </a>
                </li>
                </li>
