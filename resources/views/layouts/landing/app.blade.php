            ...
            <div class="header-wrapper">
                ...
                <div class="position-relative">
                    ...
                    <ul class="dropdown-list">
                        ...
                        <li>
                            <!-- <a href="{{ route('restaurant.create') }}"> {{ translate('messages.join_as_vendor') }}</a> -->
                            <a href="#"> {{ translate('messages.join_as_vendor') }}</a>
                        </li>
                        @endif
                        @if ($toggle_dm_registration)
                        <li>
                            <!-- <a href="{{ route('deliveryman.create') }}">{{ translate('messages.join_as_deliveryman') }}</a> -->
                            <a href="#">{{ translate('messages.join_as_deliveryman') }}</a>
                        </li>
                        @endif
                    </ul>
                </div>
                ...
                <div class="container">
                    ...
                    @if (isset($landing_data['news_letter_title']) )
                        <div class="newsletter-content position-relative">
                            <h3 class="title">
                                {{ $landing_data['news_letter_title'] ?? translate('messages.news_letter_signup') }}
                                </h3>
                            <div class="text">
                                {{ $landing_data['news_letter_sub_title'] ??  translate('messages.news_letter_signup_text') }}
                            </div>
                ...
                <div class="container">
                    <div class="footer-wrapper ps-xl-5">
                        <div class="footer-widget">
                            ...
                            <div class="txt">
                            Butcher is a complete package! It's time to empower your online meat business with powerful features
                            </div>
                            ...
                            <div class="app-btn-grp">
                                ...
                                <a href="{{ $landing_page_links['app_url_android'] }}">
                                    <img src="{{dynamicAsset('/public/assets/landing/assets_new/img/google.svg')}}" alt="">
                                </a>
                                @endif
                            @if ($landing_page_links['app_url_ios_status'])
                                <a href="{{ $landing_page_links['app_url_ios'] }}">
                                    <img src="{{dynamicAsset('/public/assets/landing/assets_new/img/apple.svg')}}" alt="">
                                </a>
                            </div>
                            @endif
                            @endif
