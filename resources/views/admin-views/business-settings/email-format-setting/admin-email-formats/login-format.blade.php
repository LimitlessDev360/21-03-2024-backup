                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                ...
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_admin_login_from_a_unknown_system,_the_Admin_gets_notified_via_email.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-text-on="<p>{{translate('If_enabled,_the_admin_will_receive_an_email_when_login_through_unknown_system')}}</p>"
                                data-text-off="<p>{{translate('If_disabled,_the_admin_will_not_receive_an_email_when_login_through_unknown_system')}}</p>"
                            ...
                            <div class="email-format-wrapper">
                                ...
                                <div class="right-content">
                                    <div class="d-flex flex-wrap justify-content-between __gap-15px mt-2 mb-5">
                                        @php($data=\App\Models\EmailTemplate::withoutGlobalScope('translate')->with('translations')->where('type','admin')->where('email_type', 'login')->first())
