                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                ...
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_a_vendor_requests_to_join_a_Campaign_and_Admin_approves_their_joining_request,_they_will_get_an_automated_Approval_email_from_the_system.')}}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-text-on="<p>{{translate('If_enabled,_vendors_will_receive_an_email_when_Admin_approves_their_Campaign_Join_Request.')}}</p>"
                                data-text-off="<p>{{translate('If_disabled,_vendors_will_not_receive_an_email_when_Admin_approves_their_Campaign_Join_Request.')}}</p>"
