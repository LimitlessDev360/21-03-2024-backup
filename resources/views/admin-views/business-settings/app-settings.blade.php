                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <h5 class="card-title mb-3">
                                <img src="{{dynamicAsset('/public/assets/admin/img/andriod.png')}}" class="mr-2" alt="">
                        ...
                        <div class="col-md-6">
                            <h5 class="card-title mb-3">
                                <img src="{{dynamicAsset('/public/assets/admin/img/apple.png')}}" class="mr-2" alt="">
                                {{ translate('For_iOS') }}
                            </h5>
                            <div class="__bg-F8F9FC-card">
                                <div class="form-group">
                        ...
                        <div class="item">
                            <div class="mb-20">
                                <div class="text-center">
                                    <img src="{{dynamicAsset('/public/assets/admin/img/app.png')}}" alt="" class="mb-20">
