                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border blue-border rounded align-items-center">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="{{ translate('Want_to_enable_the_Maintenance_Mode!') }}"
                                data-title-off="{{ translate('Want_to_disable_the_Maintenance_Mode!') }}"
                                data-text-on="<p>{{ translate('If_enabled,_all_your_apps_and_customer_website_will_be_temporarily_off.') }}</p>"
                                data-text-off="<p>{{ translate('If_disabled,_all_your_apps_and_customer_website_will_be_functional.') }}</p>"
                                class="status toggle-switch-input  {{  env('APP_MODE') == 'demo' ? 'maintenance-mode': 'dynamic-checkbox' }} "
