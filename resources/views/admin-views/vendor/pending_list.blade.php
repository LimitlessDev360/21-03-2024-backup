...
@section('title',translate('messages.New_Vendor_Join_Request'))
...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title"><i class="tio-filter-list"></i> {{ translate('messages.New_Vendor_Join_Request') }}</h1>
            <!-- Resturent List -->
