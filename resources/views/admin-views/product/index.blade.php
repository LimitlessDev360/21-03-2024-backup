        ...
        <div class="row align-items-center">
            <div class="col-sm mb-2 mb-sm-0">
                <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i>
                    {{ translate('messages.Add_New_Product') }}</h1>
            </div>
        </div>
    </div>
                        ...
                        <div class="lang_form" id="default-form">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <textarea type="text" name="description"
                                    class="form-control ckeditor min-height-154px"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row g-1 " class="variation">
                            <div class="col-lg-4 d-flex gap-2">
                                <div class="form-group mb-0 w-50">
                                    ...
                                    <input type="number" min="0" max="999999999999.99" required step="0.01"
                                        name="portions[1][price]" class="form-control"
                                        placeholder="{{ translate('messages.price') }}" required>
                                </div>
                                <div class="form-group mb-0 w-50">
                                    <label class="input-label"
                                        for="exampleFormControlInput1">{{ translate('messages.portion') }} *</label>
                                    <input type="text" min="0" max="999999999999.99" required step="0.01"
                                        name="portions[1][portion]" class="form-control"
                            ...
                            <div class="col-lg-3">
                                <div class="form-group mb-0 w-70">
                                    ...
                                    <select name="portions[1][discount_type]" class="form-control js-select2-custom">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group mb-0 w-70">
                                    ...
                                    <input type="number" min="0" max="9999999999999999999999" value="0"
                                        name="portions[1][discount]" class="form-control"
                                        placeholder="{{ translate('messages.Ex:_100') }} ">
                                </div>
                            </div>
                            <a onclick="addVariation()"
                                class="rounded d-flex fw-bold justify-content-center border border-secondary btn btn-primary  align-items-center p-3"
                                style="font-size: 18px; height: 40px; margin-top:38px;">+</a>
                        </div>
 ...
 <div class="col-lg-4 d-flex gap-2">
                                    ...
                                    <label class="input-label"
                                        ...
                                        <input type="number" min="0" max="999999999999.99"  required 
                                            step="0.01"  name="portions[` + count + `][price]" class="form-control price w-100"
                                            placeholder="{{ translate('messages.price') }}"  required>
                                    </div>
                                    <div class="form-group   mb-0 w-50"  >
                                    <label class="input-label"
                                        ...
                                        <input type="text" min="0" max="999999999999.99" required 
                                            step="0.01"  name="portions[` + count + `][portion]" class="form-control portion w-100"
                                            placeholder="{{ translate('messages.portion') }}"  required>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    ...
                                    <label class="input-label"
                                            for="exampleFormControlInput1"></label>
                                        <select name="portions[` + count + `][discount_type]" class="form-control js-select2-custom " >
                                            <option value="percent">{{ translate('messages.percent').' (%)' }}</option>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <label class="input-label"
                                        ...
                                        <input type="number" min="0" max="9999999999999999999999"
                                            value="0" name="portions[` + count + `][discount]" class="form-control"
                                            placeholder="{{ translate('messages.Ex:_100') }} " >
                                    </div>
                                </div>
