                                ...
                                <div class="col-md-6">
                                    <div class="h-100 d-flex flex-column justify-content-center">
                                        <div class="form-group mt-auto">
                                            <label class="d-block text-center">{{translate('messages.banner_image')}} <small class="text-danger">* ( {{translate('messages.ratio_1000x300')}}  )</small></label>
                                        </div>
                                        <div class="form-group mt-auto">
                                            <div class="text-center">
                                                <img class="initial-2" id="viewer"
                                                    src="{{dynamicAsset('public/assets/admin/img/900x400/img1.jpg')}}" alt="banner image"/>
                                            </div>
                                        </div>
                                        <div class="form-group mt-auto">
