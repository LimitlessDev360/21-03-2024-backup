            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">
                        ...
                        {{translate('messages.new_campaign')}}
                    </h1>
                </div>
            </div>
        </div>
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="card-title">
                                ...
                                <span>{{translate('image')}} <small class="text-danger">({{ translate('Ratio_200x200') }})</small></span>
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="form-group mb-0 h-100 d-flex flex-column">
                                <center id="image-viewer-section" class="mt-auto mb-auto">
                                    <img class="initial-15" id="viewer"
                                            src="{{dynamicAsset('/public/assets/admin/img/100x100/food-default-image.png')}}" alt="banner image"/>
                                </center>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <option selected value="">{{translate('select_vendor')}}</option>
