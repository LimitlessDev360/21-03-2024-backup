                                    ...
                                    <div class="form-group mb-0 h-100 d-flex flex-column">
                                        ...
                                        <div id="image-viewer-section" class="text-center py-3 my-auto">
                                            <img class="img--120 onerror-image" id="viewer"
                                                 src="{{\App\CentralLogics\Helpers::onerror_image_helper($campaign->image, dynamicStorage('storage/app/public/campaign/').'/'.$campaign->image, dynamicAsset('public/assets/admin/img/100x100/2.png'), 'campaign/') }}" alt="campaign image" data-onerror-image="{{dynamicAsset('public/assets/admin/img/100x100/2.png')}}"/>
                                        </div>
