...
@push('script')
    ...
    <script src="{{dynamicAsset('public/assets/admin')}}/vendor/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js"></script>
@endpush
...
<script>
    "use strict";
    let ctx = document.getElementById('user-overview');
    let myChart = new Chart(ctx, {
        ...
        $('.order-stats-update').on('change', function(){
            let type = $(this).val();
